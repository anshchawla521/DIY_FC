...
void setup()
{
  ...
  if (!initialise_IMU())
  {
    ...
    motA.attach(PB6, MIN_PULSE_LENGTH, MAX_PULSE_LENGTH);
    motB.attach(PB7, MIN_PULSE_LENGTH, MAX_PULSE_LENGTH);
    motC.attach(PB8, MIN_PULSE_LENGTH, MAX_PULSE_LENGTH);
    motD.attach(PB9, MIN_PULSE_LENGTH, MAX_PULSE_LENGTH);
