...
SPIClass SPI_1(SPI_MOSI_1, SPI_MISO_1, SPI_SCK_1); // bus for 
...
void setup()
{
  ...
  write_values_to_sensor_spi(0x7C , GYRO_CS_1 , 0x00);
  write_values_to_sensor_spi(0x59 , GYRO_CS_1 , 0x00);
  digitalWrite(GYRO_CS_1, LOW);
  SPI_1.transfer(0x5E);
  ...
  digitalWrite(GYRO_CS_1, HIGH);
  delay(2);
  write_values_to_sensor_spi(0x59 , GYRO_CS_1 , 0x01);
  delay(200);

  write_values_to_sensor_spi(0x7D , GYRO_CS_1 , 0x0E);
  write_values_to_sensor_spi(0x40 , GYRO_CS_1 , 0xA8);
  write_values_to_sensor_spi(0x42 , GYRO_CS_1 , 0xA9);
  write_values_to_sensor_spi(0x7C , GYRO_CS_1 , 0x02);

}

void loop()
{
  Serial.print(read_values_from_sensor_spi(0x21, GYRO_CS_1) , HEX); // status
  Serial.print(" ");
  Serial.print(read_values_from_sensor_spi(0x0C, GYRO_CS_1 , true)); // status
  Serial.print(" ");
  Serial.print(read_values_from_sensor_spi(0x0E, GYRO_CS_1 , true)); // status
  Serial.print(" ");
  Serial.print(read_values_from_sensor_spi(0x10, GYRO_CS_1 , true)); // status
  Serial.println(" ");
  delay(10);
